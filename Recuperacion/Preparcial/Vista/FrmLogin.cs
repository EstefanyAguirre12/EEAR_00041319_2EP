...
namespace Preparcial
{
    public partial class FrmLogin : Form
    {
        ...
        private void PoblarControlers()
        {
            ...
            //Correccion: Cambio de "Contrasenia" a "Contrasena"
        ...
        private void BttnLogin_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text.Equals(cmbUser.SelectedValue.ToString()))
            {
                ...
                //Correccion: Mostrar frmMain y esconder frmLogin 
                frmMain.Show();
                Hide();
            }
            else
        ...
        private void BttnUpdatePassword_Click(object sender, EventArgs e)
        {
            ...
            //Correccion: cambiar forma de como mostrar el formulario, de show a showdialog para luego actualizar el combobox
            frmPassword.ShowDialog();
            //Correccion: actualizar combobox con la nueva contraseña
            PoblarControlers();
        }
    }
}
