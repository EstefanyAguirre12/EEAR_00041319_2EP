...
namespace Preparcial.Vista
{
    public partial class FrmPassword : Form
    {
        ...
        {
            //Correccion: inicializando el datasource y asignandole los valores hasta el final
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            {       
                ...
                //Correccion: actualizarcontrolers hasta el final, luego de alctualizar la contraseña
                ActualizarControlers();
            }
            else
